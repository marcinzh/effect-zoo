...
class Sumh {
  ...
  val CatsMTL_Desugared__run = reg.findRound("CatsMTL_Desugared", 0).run
  val CatsMTL_RWS__run = reg.findRound("CatsMTL_RWS", 0).run
  val CatsMTL_RWS_Desugared__run = reg.findRound("CatsMTL_RWS_Desugared", 0).run
  val CatsIO__run = reg.findRound("CatsIO", 0).run
  val CatsIO_Desugared__run = reg.findRound("CatsIO_Desugared", 0).run
  val CatsIO_RWS__run = reg.findRound("CatsIO_RWS", 0).run
  val CatsIO_RWS_Desugared__run = reg.findRound("CatsIO_RWS_Desugared", 0).run
  val CatsEff__run = reg.findRound("CatsEff", 0).run
  val CatsEff_Desugared__run = reg.findRound("CatsEff_Desugared", 0).run
  val Turbolift_Local__run = reg.findRound("Turbolift_Local", 0).run
  val Turbolift_Local_Desugared__run = reg.findRound("Turbolift_Local_Desugared", 0).run
  val Turbolift_Shared__run = reg.findRound("Turbolift_Shared", 0).run
  val Turbolift_Shared_Desugared__run = reg.findRound("Turbolift_Shared_Desugared", 0).run
  ...
  val ZPure_Desugared__run = reg.findRound("ZPure_Desugared", 0).run
  val Kyo_Desugared__run = reg.findRound("Kyo_Desugared", 0).run
  ...
  @Benchmark def CatsMTL_Desugared = CatsMTL_Desugared__run()
  @Benchmark def CatsMTL_RWS = CatsMTL_RWS__run()
  @Benchmark def CatsMTL_RWS_Desugared = CatsMTL_RWS_Desugared__run()
  @Benchmark def CatsIO = CatsIO__run()
  @Benchmark def CatsIO_Desugared = CatsIO_Desugared__run()
  @Benchmark def CatsIO_RWS = CatsIO_RWS__run()
  @Benchmark def CatsIO_RWS_Desugared = CatsIO_RWS_Desugared__run()
  @Benchmark def CatsEff = CatsEff__run()
  @Benchmark def CatsEff_Desugared = CatsEff_Desugared__run()
  @Benchmark def Turbolift_Local = Turbolift_Local__run()
  @Benchmark def Turbolift_Local_Desugared = Turbolift_Local_Desugared__run()
  @Benchmark def Turbolift_Shared = Turbolift_Shared__run()
  @Benchmark def Turbolift_Shared_Desugared = Turbolift_Shared_Desugared__run()
  ...
  @Benchmark def ZPure_Desugared = ZPure_Desugared__run()
  @Benchmark def Kyo_Desugared = Kyo_Desugared__run()
